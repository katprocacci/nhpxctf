...
<html <?php language_attributes(); ?>>
    <head>
        <meta charcet="<?php bloginfo('charset'); ?>">
    ...
    <body <?php body_class(); ?>>
        ...
        <div class="container">
        <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>NHP</strong> XC / T&F</a></h1>
        ...
        <div class="site-header__menu group">
            ...
            <ul>
                ...
                <li <?php if (get_post_type() == 'meet' OR is_page('past-meets')) echo 'class="current-menu-item"'; ?>><a href="<?php echo get_post_type_archive_link('meet'); ?>">Meets</a></li>
